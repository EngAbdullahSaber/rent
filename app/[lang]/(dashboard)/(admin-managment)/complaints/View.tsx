      ...
      <AnimatePresence>
        <DialogContent size="2xl" className="h-fit">
          ...
          >
            ...
            >
              <div className="flex flex-row gap-2 justify-between w-[48%] items-center">
                <span className="text-gray-400">Name</span>
                <span className="font-medium">{t("Complaint Name")}</span>
              </div>
              <div className="flex flex-row gap-2 justify-between w-[28%] items-center">
                <span className="text-gray-400">Name</span>
                <span className="font-medium">{t("Type of complainant")}</span>
              </div>
              <div className="flex flex-row gap-2 justify-between w-[22%] items-center">
                <span className="text-gray-400">Name</span>
