...
interface UpdateCaseCategoryProps {
...
const UpdateCaseCategory: React.FC<UpdateCaseCategoryProps> = ({
  row,
  getCategoryData,
}) => {
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              <ScrollArea className="h-full">
                <div className="sm:grid sm:gap-5 space-y-4 sm:space-y-0">
                  ...
                  >
                    <Label htmlFor="Name">{t("Case Category Name")}</Label>
                    <Input
                      id="Name"
                      value={userData.name} // No more TypeScript error
                      onChange={(e) => handleInputChange(e, "name")}
                      placeholder={t("Enter Case Category Name")}
                      type="text"
                    />
                  </motion.div>
                  ...
                  >
                    <Label htmlFor="Description">
                      {t("Description Of Case Category")}
                    </Label>
                    <Textarea
                      id="Description"
              ...
              >
                ...
                >
                  {!loading ? t("Loading") : t("Update Case Category")}
                </Button>
              </motion.div>
            </form>
          </div>
...
export default UpdateCaseCategory;
