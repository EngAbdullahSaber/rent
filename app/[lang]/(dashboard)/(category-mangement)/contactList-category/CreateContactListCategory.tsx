...
const CreateContactListCategory = ({
  buttonShape,
  setFlag,
  flag,
}: {
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      ...
      if (res) {
        ...
        reToast.error(t("Failed to create Contact List Category"));
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      {buttonShape ? (
        ...
        >
          {" "}
          {t("Create Contact List Category")}
        </Button>
      ) : (
        <Button
          onClick={handleOpen}
        ...
        <DialogContent size="2xl" className="h-auto">
          <DialogHeader className="p-0">
            <DialogTitle className="text-2xl font-bold text-default-700">
              {t("Create a New Contact List Category")}
            </DialogTitle>
          </DialogHeader>
          <div>
            <div>
                    ...
                    <div className="sm:grid sm:gap-5 space-y-4 sm:space-y-0">
                      ...
                      >
                        ...
                        <Input
                          ...
                          placeholder={t("Enter Contact List Category Name")}
                          type="text"
                        />
                      </motion.div>
                      ...
                      >
                        <Label htmlFor="Description">
                          {t("Description Of Contact List Category")}
                        </Label>
                        <Textarea
                          id="Description"
...
export default CreateContactListCategory;
