...
interface UpdateContactlistCategoryProps {
...
const UpdateContactlistCategory: React.FC<UpdateContactlistCategoryProps> = ({
  row,
  getCategoryData,
}) => {
  ...
  useEffect(() => {
    if (row?.original) {
      setUserData({
        ...
        type: row.original.type || "contact_list",
      });
    }
  }, [row]);
...
export default UpdateContactlistCategory;
