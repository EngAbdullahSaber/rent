...
interface UpdateCourtCategoryProps {
...
const UpdateCourtCategory: React.FC<UpdateCourtCategoryProps> = ({
  row,
  getCategoryData,
}) => {
...
export default UpdateCourtCategory;
