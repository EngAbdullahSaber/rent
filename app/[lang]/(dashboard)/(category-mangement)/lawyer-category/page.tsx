...
import CreateLawyerCategory from "./CreateLawyerCategory";
    ...
    <div className="space-y-5">
      <div className="flex sm:flex-row xs:gap-5 xs:flex-col justify-between items-center my-5">
        ...
        >
          ...
          <BreadcrumbComponent header={"Lawyers"} body={"Lawyer Category"} />
        </motion.div>
        <motion.div
          initial={{ x: -15 }}
          whileInView={{ x: 0 }}
        ...
        >
          {permission
            ...
            .permissions.some((item: any) => item.id === 65) && (
      ...
      <Card>
        <CardHeader>
          <CardTitle> {t("Lawyer Category Details")}</CardTitle>
        </CardHeader>
        <CardContent>
          <TableData flag={flag} />
        </CardContent>
